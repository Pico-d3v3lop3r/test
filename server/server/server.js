...
else if(selectedRootCategory === 'GROCERY'){
  const insertIntoGroceries = `INSERT INTO "INVENTORY"."GROCERY"("P_ID","PRODUCTION_DATE","EXPIARY_DATE") VALUES(:pID,:prodDate,:expDate)`;
  const bindParams8 = {
    pID: pID,
